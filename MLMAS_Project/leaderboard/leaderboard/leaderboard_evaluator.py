...
class LeaderboardEvaluator(object):
    ...
    def _register_statistics(self, config, checkpoint, entry_status, crash_message=""):
        ...
        print("stats message")
        print(self.manager.scenario_duration_system)
        print(self.manager.scenario_duration_game)
        print(config.index)
        print(entry_status)
        print(checkpoint)
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            if args.record:
                ...
                print("{}/{}_rep{}.log".format(args.record, config.name, config.repetition_index))
